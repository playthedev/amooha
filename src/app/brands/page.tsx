    ...
    <>
      <style>{`
        ...
        @media (min-width: 640px) {
          .bp-section { padding: 8rem 2rem 10rem; }
        }
        .bp-inner {
          max-width: 1200px;
          margin: 0 auto;
        ...
        @media (min-width: 1024px) {
          .bp-header { grid-template-columns: 8fr 4fr; }
        }
        ...
        @media (min-width: 640px) {
          .bp-brand-card { min-height: 680px; }
        }
        ...
        .bp-brand-card:hover .bp-brand-img {
        ...
        .bp-brand-card:hover .bp-brand-overlay {
          opacity: .85;
        }
        ...
        @media (min-width: 1024px) {
          .bp-brand-content { padding: 4rem 5rem 5rem; }
        }
        ...
        .bp-pipeline {
          ...
          gap: 2rem;
          border: 1.5px dashed rgba(26,74,46,.22);
          background: #f7f3ec;
          padding: 4rem 2rem;
          text-align: center;
          flex-direction: column;
        ...
        @media (min-width: 640px) {
          .bp-pipeline { flex-direction: row; text-align: left; padding: 4rem 3rem; }
        }
        .bp-pipeline-icon {
          display: flex;
          align-items: center;
          ...
          border: 1px solid rgba(26,74,46,.15);
          background: #fff;
          flex-shrink: 0;
          color: #b8893a;
        }
        ...
        .bp-meta-tag {
          ...
          text-transform: uppercase;
          color: #2d6a46;
          border: 1px solid rgba(45,106,70,.2);
          padding: .3rem .8rem;
        }
      `}</style>
          ...
          <div className="bp-inner">
            ...
            <FadeIn delay={0.1}>
              <div className="bp-meta-row">
                <span className="bp-meta-label">Active brand · 01 of 01</span>
              ...
              >
                <img
                  src={brandImage}
                  alt="Fresh produce and nutrition ingredients"
                  className={`bp-brand-img${imgLoaded ? " loaded" : ""}`}
            ...
            <FadeIn delay={0.18}>
              <div className="bp-pipeline">
                ...
                <div>
                  <p className="bp-pipeline-title">New brands in the pipeline.</p>
